...
public class AccountServiceImpl implements AccountService {
  ...
  /**
   * updateAccount updates an existing account details
   *
   * @param details
   * @return Account
   */
  ...
  public Account updateAccount(Account details) {
    ...
    Account fetchedAccount = this.getAccount(details.getId()).get();
    return workflow.updateAccount(details, fetchedAccount);
  }
  ...
  /**
   * getAccount returns an account by passing its id.
   *
   * @param accountId

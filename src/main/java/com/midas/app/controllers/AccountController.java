...
public class AccountController implements AccountsApi {
  ...
  /**
   * PATCH /account : Update user details like first name, last name and email
   *
   * @param accountId accountId for updating user details (required)
   * @param updateAccountDto User account details for updating (required)
